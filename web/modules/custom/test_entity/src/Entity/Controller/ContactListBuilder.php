...
namespace Drupal\test_entity\Entity\Controller;
...
/**
 * Provides a list controller for test_entity_contact entity.
 *
 * @ingroup test_entity
 */
class ContactListBuilder extends EntityListBuilder {
    ...
    $build['description'] = [
      '#markup' => $this->t('Content Entity Example implements a Contacts model. These contacts are fieldable entities. You can manage the fields on the <a href="@adminlink">Contacts admin page</a>.', array(
        '@adminlink' => \Drupal::urlGenerator()
          ->generateFromRoute('test_entity.contact_settings'),
      )),
    ];
  ...
  public function buildRow(EntityInterface $entity) {
    /* @var $entity \Drupal\test_entity\Entity\Contact */
    $row['id'] = $entity->id();
